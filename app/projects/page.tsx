  ...
  return (
    ...
    <h1 className="text-3xl font-bold text-red-600 mb-4 p-4 pb-0">Research Projects</h1>
      <div className="z-10 flex flex-row flex-wrap gap-4 justify-center max-w-fit lg:flex pb-12">
        <ProjectCard href={DEDUCTIVE_SAR_HREF} projectName={DEDUCTIVE_SAR_TITLE} imageSource={DEDUCTIVE_SAR_IMAGE_SOURCE} projectDescription={DEDUCTIVE_SAR_INFO} projectContact={DEDUCTIVE_SAR_CONTACTS} funding={DEDUCTIVE_SAR_FUNDING} status={DEDUCTIVE_SAR_STATUS}/>
      </div>
      <h1 className="text-3xl font-bold text-red-600 mb-4 p-4 pb-0">Tools</h1>
      <div className="z-10 flex flex-row flex-wrap gap-4 justify-center max-w-fit lg:flex pb-12">
        <ProjectCard href={ANDROMEDA_PLATFORM_HREF} projectName={ANDROMEDA_PLATFORM_TITLE} imageSource={ANDROMEDA_PLATFORM_IMAGE_SOURCE} projectDescription={ANDROMEDA_PLATFORM_DESC} projectContact={ANDROMEDA_PLATFORM_CONTACTS} funding={ANDROMEDA_PLATFORM_FUNDING} status={ANDROMEDA_PLATFORM_STATUS}/>
        <ProjectCard href={CLASSVIZ_HREF} projectName={CLASSVIZ_TITLE} imageSource={CLASSVIZ_IMAGE_SOURCE} projectDescription={CLASSVIZ_DESC} projectContact={CLASSVIZ_CONTACTS} funding={CLASSVIZ_FUNDING} status={CLASSVIZ_STATUS}/>
      </div>
    </main>
    <Footer/>
  </NextUIProvider>
