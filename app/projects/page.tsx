...
export default function Home() {
  return (
    ...
    <h1 className="text-6xl font-bold text-red-600 mb-4 p-6 pb-0">Research Projects</h1>
      <div className="z-10 flex flex-row flex-wrap gap-4 justify-center max-w-fit p-12 lg:flex pb-12">
      ...
      <h1 className="text-6xl font-bold text-red-600 mb-4 p-6 pb-0">Tools</h1>
